...
//This is purely for backwards compatibiltiy with DR2 code
/datum/reagent
	var/id
...
/datum/reagent/consumable/ethanol/daturatea/on_mob_add(mob/living/M) //spiritual shizzle, also admemes getting booled on
	ADD_TRAIT(M,TRAIT_SPIRITUAL,TRAIT_GENERIC)
	M.set_drugginess(15)
	M.hallucination += 20
	..()

/datum/reagent/consumable/ethanol/daturatea/on_mob_delete(mob/living/M)
	REMOVE_TRAIT(M,TRAIT_SPIRITUAL,TRAIT_GENERIC)
	M.set_drugginess(0)
	M.hallucination += 0
	..()
...
/datum/reagent/consumable/ethanol/nukavictory/on_mob_life(mob/living/carbon/M)
	ADD_TRAIT(M,TRAIT_BIG_LEAGUES, id)
...
/datum/reagent/consumable/ethanol/nukavictory/on_mob_delete(mob/living/M)
	REMOVE_TRAIT(M,TRAIT_BIG_LEAGUES, id)
	..()
...
/datum/reagent/consumable/ethanol/nukaxtreme/on_mob_life(mob/living/carbon/M)
/*
Cool effect but just tends to crash your game
	if(M.hud_used)
...
// CIT TG ALCOHOLS - These should be stripped from code but they love slapping filepaths fucking everywhere. TODO: STRIP THESE
